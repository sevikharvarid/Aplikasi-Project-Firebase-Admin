package com.example.faq_chatapp_admin;
...
public class ViewQuestion extends AppCompatActivity {
    ...
    EditText replyText;
    Button replyButton, changeReplyButton,btnDeleteQuestion;
                ...
                if( model.getAuthor().equalsIgnoreCase(currentUser.getEmail().toString()) ){
                    ...
                    btnDeleteQuestion.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            DatabaseReference dbRef2 = database.getReference("posts");
                            dbRef.child(String.valueOf(id)).removeValue();
                            dbRef2.child(String.valueOf(id)).removeValue();
                            Intent i = new Intent(ViewQuestion.this,MainFeed.class);
                            startActivity(i);
                    ...
                    btnDeleteQuestion.setVisibility(View.INVISIBLE);
                }
            }
        };
